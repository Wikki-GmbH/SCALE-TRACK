...
#=
    ...
    and afterwards calls one of the two drivers defined in coupling.jl,

        init_async_tracking!(executor; caseParameters...)
        init_sync_tracking!(executor; caseParameters...)
