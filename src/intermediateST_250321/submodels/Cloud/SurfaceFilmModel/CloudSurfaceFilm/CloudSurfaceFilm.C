...
#include "CloudSurfaceFilm.H"

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

template<class CloudType>
Foam::CloudSurfaceFilm<CloudType>::CloudSurfaceFilm
(
...
Foam::CloudSurfaceFilm<CloudType>::CloudSurfaceFilm
(
    const CloudSurfaceFilm<CloudType>& sfm
)
:
...
void Foam::CloudSurfaceFilm<CloudType>::absorbInteraction
(
    filmType& film,
    const parcelType& p,
    const polyPatch& pp,
...
template<class CloudType>
bool Foam::CloudSurfaceFilm<CloudType>::transferParcel
(
    parcelType& p,
    const polyPatch& pp,
    bool& keepParticle
...
template<class CloudType>
void Foam::CloudSurfaceFilm<CloudType>::cacheFilmFields
(
...
template<class CloudType>
void Foam::CloudSurfaceFilm<CloudType>::setParcelProperties
(
    parcelType& p,
    const label filmFacei
) const
...
template<class CloudType>
void Foam::CloudSurfaceFilm<CloudType>::info()
{
